SERVICE = mccorklereadutilstestperl
SERVICE_CAPS = mccorkleReadUtilsTestPerl
SPEC_FILE = mccorkleReadUtilsTestPerl.spec
URL = https://kbase.us/services/mccorklereadutilstestperl
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
