...
class mccorkleReadUtilsTestPerl(object):
    ...
    def filter_contigs(self, params, context=None):
        ...
        :returns: instance of type "FilterContigsResults" -> structure:
           parameter "new_contigset_ref" of type "ws_contigset_id" (The
           workspace ID for a ContigSet data object. @id ws
        ...
        return self._client.call_method(
            'mccorkleReadUtilsTestPerl.filter_contigs',
            [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('mccorkleReadUtilsTestPerl.status',
