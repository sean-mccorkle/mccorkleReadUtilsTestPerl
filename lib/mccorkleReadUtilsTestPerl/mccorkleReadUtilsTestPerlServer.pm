package mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServer;
...
sub get_service_name
{
    ...
    if(!defined $ENV{$SERVICE}) {
        return 'mccorkleReadUtilsTestPerl';
    }
    return $ENV{$SERVICE};
}
...
sub call_method {
    ...
    my $ctx = mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServerContext->new($self->{loggers}->{userlog},
...
{
    # Service mccorkleReadUtilsTestPerl requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for mccorkleReadUtilsTestPerl but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service mccorkleReadUtilsTestPerl.");
    }
...
package mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServerContext;

use strict;

=head1 NAME

mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServerContext
...
package mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServer->new(
