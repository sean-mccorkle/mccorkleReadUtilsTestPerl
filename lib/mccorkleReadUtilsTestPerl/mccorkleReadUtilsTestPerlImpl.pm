package mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlImpl;
use strict;
...
sub new
{
    ...
    my $wsInstance = $cfg->val('mccorkleReadUtilsTestPerl','workspace-url');
...
sub filter_contigs
{
    ...
    my $ctx = $mccorkleReadUtilsTestPerl::mccorkleReadUtilsTestPerlServer::CallContext;
    my($return);
